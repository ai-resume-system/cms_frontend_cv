    ...
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
        <form
          ...
          className="lg:col-span-3 bg-surface-container-lowest rounded-xl border border-outline-variant p-3 sm:p-4 shadow-sm"
        >
          <div className="flex flex-col gap-3 sm:gap-4">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center">
              ...
              >
                ...
                <span className="font-sans text-xs font-semibold text-on-surface sm:inline hidden">
                  Tìm kiếm
                </span>
              </button>
            </div>
        ...
        <div className="bg-primary text-white rounded-xl p-4 shadow-sm flex flex-col justify-center overflow-hidden relative min-h-[80px] sm:min-h-[92px]">
          <div className="relative z-10 text-left">
            <p className="font-sans text-[10px] sm:text-xs font-semibold opacity-80 uppercase tracking-wider">
              Tổng người dùng
            </p>
            <h3 className="font-headline text-2xl sm:text-3xl font-extrabold mt-1">
              {totalItems}
            </h3>
          </div>
                  ...
                  users.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4 font-medium truncate max-w-[200px]">
                          {item.email}
                        </td>
                        <td className="px-3 sm:px-6 py-3 sm:py-4">
                          <span
                            className={`px-2 sm:px-3 py-1 rounded-full text-[10px] font-bold border whitespace-nowrap ${
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4">
                          <div className="flex items-center gap-2">
                            <span
                              className={`w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full shrink-0 ${statusConfig.dotClass}`}
                            ></span>
                            <span
                              className={`font-semibold whitespace-nowrap ${statusConfig.textClass}`}
                            >
                              {statusConfig.label}
                            </span>
                          </div>
